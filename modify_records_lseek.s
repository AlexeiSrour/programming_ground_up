...
# Reset the file pointer to the start of the read record
movl $SYS_LSEEK, %eax
movl ST_READ_FILEDES(%ebp), %ebx
movl $-RECORD_SIZE, %ecx
movl $1, %edx	# magic number, seek from current point in file
int $LINUX_SYSCALL
